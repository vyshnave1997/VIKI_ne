        ...
        <div className="w-full flex items-center justify-center text-white cta">
            <div className="mx-8 w-full h-96 text-center lg:text-left py-16 px-12 flex lg:justify-between items-center">                    
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    <div className="mb-4">
                        <p className='text-2xl md:text-4xl font-bold mb-4'>Empowering Our Clients with Reliable IT Solutions</p>
                        <p className="text-lg md:text-2xl">Your Success is Our Top <span className='font-black'> Priority!</span></p>
                    </div>
