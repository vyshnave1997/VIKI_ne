                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6" id='about' >
                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="fade-up">
                        ...
                        <div className="flex-col my-4 text-center lg:text-left lg:my-0 lg:justify-end w-full lg:w-1/2 px-8" data-aos="zoom-in" data-aos-delay="500">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>At VIKI, we specialize in delivering innovative IT solutions tailored to your unique needs. Our team of experts is dedicated to transforming technology into a strategic asset for your business, ensuring seamless integration, robust support, and exceptional service.</p>
                            </div>
                            
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We partner with you to drive growth, enhance efficiency, and achieve your goals through cutting-edge technology and personalized attention.</p>
                            </div>
